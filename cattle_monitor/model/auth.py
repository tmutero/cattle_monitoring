...
from sqlalchemy.types import Unicode, Integer, DateTime, Boolean, Date
...
group_permission_table = Table('tg_group_permission', metadata,
    ...
    Column('permission_id', Integer, ForeignKey('tg_permission.permission_id', onupdate="CASCADE", ondelete="CASCADE"), primary_key=True))
...
# This is the association table for the many-to-many relationship between roles and users.
user_role_table = Table('tg_user_role', metadata,
    Column('user_id', Integer, ForeignKey('tg_user.user_id', onupdate="CASCADE", ondelete="CASCADE"), primary_key=True),
    Column('role_id', Integer, ForeignKey('tg_role.id', onupdate="CASCADE", ondelete="CASCADE"), primary_key=True))
...
class LoginHistory(DeclarativeBase):
    __tablename__='tbl_login_history'
    id = Column(Integer, autoincrement=True, primary_key=True)
    user_id = Column(Integer, nullable=False)
    added = Column(DateTime, default=datetime.now)
