...
import cattle_monitor
from cattle_monitor import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': cattle_monitor.model,
    'DBSession': cattle_monitor.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "2120c0b3-e011-4a00-ac2b-5a0f3e204eb4",
